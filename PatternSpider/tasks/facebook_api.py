...
class FacebookApiTask(TaskManage):
    def add_facebook_user_friends_api_task(self, user_names):
    ...
    def add_facebook_post_share_api_task(self,post_urls):
...
if __name__ == '__main__':
    # FacebookApiTask().add_facebook_user_friends_api_task(
    #     [
    #         'profile.php?id=100002361475114'
    #     ]
    # )
    FacebookApiTask().add_facebook_post_share_api_task([
        'https://www.facebook.com/920thRescueWing/posts/4740648582623957'
    ])
